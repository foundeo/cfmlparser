...
<cfif Len(form.code)>
	...
	<cfloop array="#statements#" index="stmt">
		<cfdump var="#{attr: stmt.getAttributes(), text:stmt.getText(), expr:stmt.getExpressions(), vars:stmt.getVariables(), startPosition:stmt.getStartPosition(), isFunc:stmt.isFunction()}#" expand="false" label="#stmt.getName()#">
